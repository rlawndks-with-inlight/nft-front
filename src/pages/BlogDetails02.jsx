...
import img1 from "../assets/images/product/product5.png";
import img2 from "../assets/images/product/product6.png";
import img3 from "../assets/images/product/product7.png";
import img4 from "../assets/images/product/product8.png";
import rs1 from "../assets/images/author/author1.png";
import rs2 from "../assets/images/author/author1.png";
import rs3 from "../assets/images/author/author1.png";
import rs4 from "../assets/images/author/author1.png";
                    ...
                    <li key={idx.id}>
                      <div className="post-img">
                        <img
                          src={idx.img}
                          alt="Post New"
                          style={{ widows: "44px", height: "44px" }}
                        />
                      </div>
                      <div className="post-content">
                        <h6 className="title">
                          <Link to="/blog-details-v1">{idx.title} </Link>
                        </h6>
