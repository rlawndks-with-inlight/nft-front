                    ...
                    <div className="row ">
                        <div className="col-xl-9 col-lg-8 ">
                            <div className="add-nft-inner">
                                ...
                                <p className="sub">사용 가능한 지갑 제공업체 중 하나와 연결하거나 새 지갑 제공업체를 만드세요.</p>
                                <ul className="blockchain-button">
                                    ...
                                    <li><Link to="#">더 많은 옵션보기</Link></li>
                                </ul>

                                <h6 className="title">항목 유형 선택</h6>
                                <p className="sub">각각은 그들은 모두 같은 목적을 수행합니다.</p>
                                ...
                                <Tabs className='tf-tab'>
                                    ...
                                    <div className="tab-create-item">
                                                ...
                                                <p className="sub">그러나 각각은 다른 접근 방식을 취하고 다른 장단점을 만듭니다.</p>

                                                <div className="drag-upload">
                                                    <input type="file" />
                                                    <img src={icon5} alt="Binasea" />
                                                    <h6 className="title">아이템을 드래그 해서 생성하세요.</h6>
                                                    <p className="sub-title">PNG, GIF, WebP, MP4 Or MP3. Maximum File Size 100 Mb.</p>
                                                </div>

                                                <h6 className="title">항목 업로드</h6>
                                                <p className="sub mb22">그러나 각각은 다른 접근 방식을 취하고 다른 장단점을 만듭니다.</p>

                                                <fieldset>
                                                    <label >항목 이름 지정</label>
                                                    <input type="text"  placeholder="교환 가능한 로고 티셔츠" />
                                                </fieldset>

                                                <fieldset>
                                                    <label >간단한 설명을 입력하세요.</label>
                                                    <input type="text"  placeholder="구매 후 티셔츠를 드립니다" />
                                                </fieldset>

                                                <fieldset className="propertise">
                                                    <label className="mb8">속성 추가</label>
                                                    <ul className="propertise-list">
                                                        <li><Link to="#">미술<i className="fal fa-times"></i></Link></li>
                                                        <li><Link to="#">체형<i className="fal fa-times"></i></Link></li>
                                                        <li><Link to="#">얼굴색<i className="fal fa-times"></i></Link></li>
                                                    </ul>
                                                </fieldset>

                                                <div className="set-item">
                                                    <fieldset>
                                                        <label className="mb8">품목 가격 또는 시작 입찰가 설정</label>
                                                ...
                                                <p className="sub mb20">그들은 모두 같은 목적을 수행합니다.</p>
                                                ...
                                                <div className="bottom-button">
                                                    <Link to="#" className="tf-button active">게시하기</Link>
                                                    <Link to="#" className="tf-button">모두 삭제</Link>
                                                </div>
                                            </div>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            ...
                            <div className="sc-product style1">
                                <div className="top">
                                    <Link to="#" className="tag">귀여운 아기 #1</Link>
                                ...
                                <div className="bottom">
                                    <div className="details-product">
                                        <div className="author">
                                            ...
                                            <div className="content">
                                                ...
                                                <div className="name"> <Link to="#">지은이</Link></div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="product-button">
                                        <Link to="#" data-toggle="modal" data-target="#popup_bid" className="tf-button"> <span className="icon-btn-product"></span> 입찰하기</Link>
                                    </div>
