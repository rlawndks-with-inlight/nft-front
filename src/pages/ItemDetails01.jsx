                            ...
                            <div className="box-bid">
                              ...
                              <div className="infor">
                                <div className="history">
                                  <span className="price">{idx.price}</span> by{" "}
