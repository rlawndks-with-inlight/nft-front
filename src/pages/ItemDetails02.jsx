...
import img1 from '../assets/images/product/product2.png'
                                ...
                                <div className="content">
                                    <div className="content-top">
                                        <div className="author">
                                            <img src={avt1} alt="Binasea" style={{ width: "46px", height: "46px" }}/>
                                            ...
                                            <div className="tab-details">
...

                                                        {
                                                            tabDetails.map(idx => (
                                                                <div key={idx.id} className="author">
                                                                    ...
                                                                    <div className="infor">
                                                                        <img src={idx.avt} alt="Binasea" style={{ width: "36px", height: "36px" }}/>
                                                    ...
                                                    <ul className="properties">
                                                        ...
                                                        <li><Link to="#"><svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            Body: Red</Link></li>
                                                        <li><Link to="#" className="active">더 불러오기</Link></li>
                                                    </ul>
                                                </div>
                                        </TabPanel>
                                        <TabPanel >
                                                ...
                                                tabHistory.map(idx => (
                                                    <li key={idx.id}>
                                                        <div className="box-history">
                                                            <div className="infor">
                                                                <div className="img"><img src={idx.avt} alt="Binasea"  style={{ width: "44px", height: "44px" }}/></div>
                                                                <div className="content">
